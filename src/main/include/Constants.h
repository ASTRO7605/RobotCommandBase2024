...
namespace PoseEstimationConstant
{
    ...
    constexpr std::array<double, 3> kVisionStdDevs_XYPerMeterSquared_Left{2.5, 2.5,
                                                                          0.999};
    constexpr std::array<double, 3> kVisionStdDevs_XYPerMeterSquared_Right{2.5, 2.5,
                                                                           0.999};
    constexpr frc::Translation2d blueSpeakerPoseMeters = frc::Translation2d{
        units::meter_t{units::inch_t{-1.5}}, units::meter_t{units::inch_t{218.42}}};
    constexpr frc::Translation2d redSpeakerPoseMeters =
        frc::Translation2d{units::meter_t{units::inch_t{652.73}},
                           units::meter_t{units::inch_t{218.42}}};
} // namespace PoseEstimationConstant
...
namespace ShooterConstant
{
    ...
    constexpr double FConversionFactorWheels =
        1.0 / 42.0; // ticks * F -> wheel rotations
    constexpr double FConversionFactorPositionAngle =
        3600.0 / 4096.0; // ticks * F -> 0.1 degres
    constexpr double
        FConversionFactorVelocityAngle = // ticks/100ms * F -> 0.1 degres/s
        36000.0 / 4096.0;
    constexpr double
        FConversionFactorAccelerationAngle = // ticks/100ms * F -> 0.1 degres/s^2
        36000.0 / 4096.0;
    ...
    constexpr double kPercentOutputAngle =
        0.1;                             // dixieme de degre par seconde pour mode manuel
    ...
    constexpr std::pair<units::meter_t, double> firstDistanceWheelSpeedsCouple =
        std::make_pair(1_m, 3000);
    constexpr std::pair<units::meter_t, double> firstDistanceShooterAngleCouple =
        std::make_pair(1_m, 500);
    extern const std::vector<std::pair<units::meter_t, double>>
        wheelSpeedsAccordingToDistance;
    extern const std::vector<std::pair<units::meter_t, double>>
        shooterAngleAccordingToDistance;
} // namespace ShooterConstant
...
namespace BarreConstant
{
    ...
    constexpr double FConversionFactorPosition1erJoint =
        1800.0 / 4096.0; // ticks * F -> 0.1 degres
    ...
    constexpr double FConversionFactorPosition2eJoint =
        3600.0 / 4096.0; // ticks * F -> 0.1 degres
...
namespace ClimberConstant
{
    ...
    constexpr double FConversionTenthInchPerSecondSquaredToMeterPerSecondSquared =
        0.00254;
