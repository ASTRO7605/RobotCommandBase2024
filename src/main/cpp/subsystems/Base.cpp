...
Base::Base()
    : m_PoseEstimator{kDriveKinematics,
                      ...
                      PoseEstimationConstant::kVisionStdDevs}, // important to follow kinematics
                                                               // construction order
      m_VisionFront{VisionConstant::TableNameFront}, m_VisionBack{VisionConstant::TableNameBack} {
...
void Base::Periodic() {
    ...
    frc::SmartDashboard::PutNumber("FrontRightModuleAbsolutePosition",
                                   m_FrontRightModule.GetCANcoderAbsolutePosition());

    frc::SmartDashboard::PutNumber("FrontRightModuleSparkMaxPosition",
                                   m_FrontRightModule.GetTurningSparkMaxPosition());

    frc::SmartDashboard::PutNumber("FrontRightModuleDrivingPosition",
                                   m_FrontRightModule.GetDrivingPosition());

    frc::SmartDashboard::PutNumber("FrontRightModuleDrivingVelocity",
                                   m_FrontRightModule.GetDrivingVelocity());

    frc::SmartDashboard::PutNumber("FrontLeftModuleAbsolutePosition",
                                   m_FrontLeftModule.GetCANcoderAbsolutePosition());

    frc::SmartDashboard::PutNumber("FrontLeftModuleSparkMaxPosition",
                                   m_FrontLeftModule.GetTurningSparkMaxPosition());

    frc::SmartDashboard::PutNumber("FrontLeftModuleDrivingPosition",
                                   m_FrontLeftModule.GetDrivingPosition());

    frc::SmartDashboard::PutNumber("FrontLeftModuleDrivingVelocity",
                                   m_FrontLeftModule.GetDrivingVelocity());

    frc::SmartDashboard::PutNumber("RearLeftModuleAbsolutePosition",
                                   m_RearLeftModule.GetCANcoderAbsolutePosition());

    frc::SmartDashboard::PutNumber("RearLeftModuleSparkMaxPosition",
                                   m_RearLeftModule.GetTurningSparkMaxPosition());

    frc::SmartDashboard::PutNumber("RearLeftModuleDrivingPosition",
                                   m_RearLeftModule.GetDrivingPosition());

    frc::SmartDashboard::PutNumber("RearLeftModuleDrivingVelocity",
                                   m_RearLeftModule.GetDrivingVelocity());

    frc::SmartDashboard::PutNumber("RearRightModuleAbsolutePosition",
                                   m_RearRightModule.GetCANcoderAbsolutePosition());

    frc::SmartDashboard::PutNumber("RearRightModuleSparkMaxPosition",
                                   m_RearRightModule.GetTurningSparkMaxPosition());

    frc::SmartDashboard::PutNumber("RearRightModuleDrivingPosition",
                                   m_RearRightModule.GetDrivingPosition());

    frc::SmartDashboard::PutNumber("RearRightModuleDrivingVelocity",
                                   m_RearRightModule.GetDrivingVelocity());
...
void Base::SetRobotPoseVisionEstimateFront() {
    ...
    m_PoseEstimator.AddVisionMeasurement(
        ...
        (frc::Timer::GetFPGATimestamp() - estimate.latency), std_devs);
