...
Barre::Barre()
    ...
    m_MoteurDeuxiemeJoint.ConfigForwardSoftLimitThreshold(
        BarreConstant::kForwardSoftLimit2eJoint / BarreConstant::FConversionFactorPosition2eJoint);
    m_MoteurDeuxiemeJoint.ConfigReverseSoftLimitThreshold(
        BarreConstant::kReverseSoftLimit2eJoint / BarreConstant::FConversionFactorPosition2eJoint);
...
void Barre::SeedEncoder1erJoint() {
