...
Shooter::Shooter()
    ...
    m_leftMotorEncoder.SetPositionConversionFactor(
        ShooterConstant::conversionFactorWheels); // 42 counts per revolution
    m_leftMotorEncoder.SetVelocityConversionFactor(ShooterConstant::conversionFactorWheels);

    m_rightMotorEncoder.SetPositionConversionFactor(
        ShooterConstant::conversionFactorWheels); // 42 counts per revolution
    m_rightMotorEncoder.SetVelocityConversionFactor(ShooterConstant::conversionFactorWheels);
